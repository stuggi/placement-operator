...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlacementAPIOverrideSpec) DeepCopyInto(out *PlacementAPIOverrideSpec) {
	*out = *in
	if in.Route != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlacementAPIOverrideSpec.
func (in *PlacementAPIOverrideSpec) DeepCopy() *PlacementAPIOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(PlacementAPIOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
